...
if [ ! -f "$CERT_PATH" ]; then
    ...
    certbot certonly --standalone --agree-tos --email abdofadlane128@gmail.com \
    -d garb-anzo.tech -d afadlane.garb-anzo.tech -d www.garb-anzo.tech --expand --non-interactive
else
